...
CREATE TABLE `nota_categoria` (
  ...
  CONSTRAINT `nota_categoria_ibfk_1` FOREIGN KEY (`Nota_ID`) REFERENCES `nota` (`ID`),
  CONSTRAINT `nota_categoria_ibfk_2` FOREIGN KEY (`Categoria_ID`) REFERENCES `categoria` (`ID`)
...
INSERT INTO `nota_categoria` VALUES (1,1),(2,2);
