...
CREATE TABLE `usuario_categoria` (
  ...
  CONSTRAINT `usuario_categoria_ibfk_1` FOREIGN KEY (`Usuario_ID`) REFERENCES `usuario` (`ID`),
  CONSTRAINT `usuario_categoria_ibfk_2` FOREIGN KEY (`Categoria_ID`) REFERENCES `categoria` (`ID`)
...
INSERT INTO `usuario_categoria` VALUES (1,1),(2,2);
